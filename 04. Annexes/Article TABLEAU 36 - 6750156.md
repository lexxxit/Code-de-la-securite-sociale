...
Dermite eczématiforme récidivant après nouvelle exposition au risque ou confirmée par un test épicutané positif au produit
manipulé.
...
Tournage, décolletage, fraisage, perçage, filetage, taraudage, alésage, sciage, rectification et d'une façon générale,
travaux d'usinage mécanique des métaux comportant l'emploi de lubrifiants et de fluides de refroidissement.
