...
Le nombre d'allocations journalières versées au titre d'un même enfant au cours d'un mois civil à l'un ou aux deux membres du
couple ne peut être supérieur à un nombre maximal fixé par décret.
